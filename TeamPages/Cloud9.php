...
<h1 id="standingsTitle" align="center">Cloud 9</h1>
<h2 id="gameTitle" align="center">North American League of Legends Team</h2>
    ...
    $sql = "SELECT First, Last, Screen, Position FROM lcsplayerlist WHERE Team='Cloud9'";
...
<h2 id="gameTitle" align="center">North American Rainbow 6 Team</h2>
    ...
    $sql = "SELECT First, Last, Screen FROM rainbowsixplayerlist WHERE Team='Cloud9'";
    $result = $conn-> query($sql);
