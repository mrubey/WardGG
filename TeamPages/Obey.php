...
<h1 id="standingsTitle" align="center">Obey Alliance</h1>
<h2 id="gameTitle" align="center">European Smite Team</h2>
    ...
    $sql = "SELECT First, Last, Screen, Position FROM smiteplayerlist WHERE Team='Obey Alliance'";
...
<h2 id="gameTitle" align="center">North American Rainbow 6 Team</h2>
    ...
    $sql = "SELECT First, Last, Screen FROM rainbowsixplayerlist WHERE Team='Obey Alliance'";
    $result = $conn-> query($sql);
