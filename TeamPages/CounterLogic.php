...
<h1 id="standingsTitle" align="center">Counter Logic Gaming</h1>
<h2 id="gameTitle" align="center">Smite Team</h2>
    ...
    $sql = "SELECT First, Last, Screen, Position FROM smiteplayerlist WHERE Team='Counter Logic Gaming'";
    ...
    $sql = "SELECT First, Last, Screen, Position FROM lcsplayerlist WHERE Team='Counter Logic Gaming'";
    $result = $conn-> query($sql);
