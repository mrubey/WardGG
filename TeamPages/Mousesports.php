...
<h1 id="standingsTitle" align="center">Mousesports</h1>
<h2 id="gameTitle" align="center">Smite Team</h2>
    ...
    $sql = "SELECT First, Last, Screen, Position FROM smiteplayerlist WHERE Team='Mousesports'";
...
<h2 id="gameTitle" align="center">North American Rainbow 6 Team</h2>
    ...
    $sql = "SELECT First, Last, Screen FROM rainbowsixplayerlist WHERE Team='Mousesports'";
    $result = $conn-> query($sql);
